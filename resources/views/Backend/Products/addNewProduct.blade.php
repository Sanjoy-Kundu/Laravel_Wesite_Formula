                        ...
                        <div class="col-sm-8 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="theme-form theme-form-2 mega-form" action="{{ url('product/insert') }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            <label class="form-label-title col-sm-3 mb-0">Product
                                                Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="product_description" id="" rows="5"></textarea>
                                            </div>
                                        </div>
                                        {{--     <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="theme-form theme-form-2 mega-form">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3"></div>
                                                    <div class="col-sm-9 mt-5"> <button class="btn btn-success">Add
                                                            Product</button></div>
                                                </div>
