                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                ...
                                <small class="ms-2">
                                    <b class="text-primary">{{ auth()->user()->name }}</b> <br>
                                    {{ auth()->user()->email }}
                                </small>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="card-header-2">
                                                <h5>Update Your Category Here</h5>
                                            </div>
                                            @if (session('success'))
                                            ...
                                            <form class="theme-form theme-form-2 mega-form" method="POST"
                                                action="{{ url('category/edit') }}/{{ $update_categoryInfo->id }}">
                                                @csrf
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{ $update_categoryInfo->name }}">
                                                        @error('name')
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    <label class="form-label-title col-sm-3 mb-0">Category
                                                        Description</label>
                                                    <div class="col-sm-9">
                                                        <textarea id="" rows="10" class="form-control" name="description">{{ $update_categoryInfo->description }}</textarea>
                                                        @error('description')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
