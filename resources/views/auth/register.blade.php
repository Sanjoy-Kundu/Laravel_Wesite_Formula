...
<head>
    ...
    {{--     <link rel="stylesheet" type="text/css" href="{{ asset('{{ asset('assets') }}') }}/css/vendors/bootstrap.css"> --}}
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6 me-auto">
                    <div class="log-in-box">
                        ...
                        <p class="text center">Already have an account? please <a href="{{ url('login') }}">Login</a>
                        </p>
                        <div class="log-in-button">
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.github.com/" class="btn google-button w-100">
